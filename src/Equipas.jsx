...
// A lógica de paginação é simples: cada alteração da página gera um novo pedido à API,
// garantindo que a UI mostra apenas um subconjunto das equipas por vez.
function Equipas() {
  ...
  // Busca as equipas sempre que a página atual muda.
  useEffect(() => {
